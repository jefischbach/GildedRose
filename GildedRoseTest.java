...
public class GildedRoseTest {
    ...
    public static void foo() {
        ...
        appTest = new GildedRose(new Item[]{new Item(SULFURAS,10,80)});
        appTemoin = new GildedRose(new Item[]{new Item(SULFURAS,10,80)});
        appTest.updateQuality();
        assertEquals(appTest,appTemoin);
        ...
        appTest = new GildedRose(new Item[]{new Item(BACKSTAGE,40,20)});
        appTemoin = new GildedRose(new Item[]{new Item(BACKSTAGE,39,21)});
        appTest.updateQuality();
        assertEquals(appTest,appTemoin);
        ...
        appTest = new GildedRose(new Item[]{new Item(BACKSTAGE,8,20)});
        appTemoin = new GildedRose(new Item[]{new Item(BACKSTAGE,7,22)});
        appTest.updateQuality();
        assertEquals(appTest,appTemoin);

        // Les items "Backstage passes..." gagnent en qualité avec le temps : trois points chaque jour s'il en 5 ou moins avant péremption
        appTest = new GildedRose(new Item[]{new Item(BACKSTAGE,4,20)});
        appTemoin = new GildedRose(new Item[]{new Item(BACKSTAGE,3,23)});
        appTest.updateQuality();
        assertEquals(appTest,appTemoin);
        ...
        appTest = new GildedRose(new Item[]{new Item(BACKSTAGE,0,20)});
        appTemoin = new GildedRose(new Item[]{new Item(BACKSTAGE,-1,0)});
        appTest.updateQuality();
        assertEquals(appTest,appTemoin);

        // La qualité des items "Backstage passes..." est maintenue à 0 après que la date de péremption est passée
        appTest = new GildedRose(new Item[]{new Item(BACKSTAGE,-5,0)});
        appTemoin = new GildedRose(new Item[]{new Item(BACKSTAGE,-6,0)});
        appTest.updateQuality();
        assertEquals(appTest,appTemoin);
